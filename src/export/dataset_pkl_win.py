...
It is possible to interrupt the process at the end of the current iteration by pressing Ctrl+C. 
...
def export_dataset_pkl(cfg: DictConfig) -> None:
    ...
    for i, (params, audio, _) in enumerate(pbar):
        try:
            ...
            print(
                "Received KeyboardInterrupt, the export will be aborted at the end of the current iteration..."
            )
            is_interrupted = True
