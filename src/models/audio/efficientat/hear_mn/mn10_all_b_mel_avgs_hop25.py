...
def get_basic_model(model_name="mn10_as_hop_25", **kwargs):
    mel = AugmentMelSTFT(n_mels=128, sr=32000, win_length=800, hopsize=800, n_fft=1024)
