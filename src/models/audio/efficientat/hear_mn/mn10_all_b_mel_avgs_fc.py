...
def load_model(
    model_file_path="",
    model_name="mn10_as_fc",
    mode=("b5", "b11", "b13", "b15", "mel_avgs"),
    head_type="fully_convolutional",
):
    model = get_basic_model(model_name=model_name, mode=mode, head_type=head_type)
...
def get_basic_model(model_name="mn10_as_fc", head_type="fully_convolutional", **kwargs):
