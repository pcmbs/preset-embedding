...
def get_basic_model(model_name="mn10_as_hop_20", **kwargs):
    mel = AugmentMelSTFT(n_mels=128, sr=32000, win_length=800, hopsize=640, n_fft=1024)
